...
const styles = {
  ...
  welcomeHero: { width: "100%", maxWidth: 860, margin: "0 auto" },
  welcomeGlowCard: { position: "relative", padding: "26px 22px", background: "rgba(255,255,255,0.94)", borderRadius: 28, border: "1px solid rgba(0,0,0,0.08)", boxShadow: "0 18px 50px rgba(0,0,0,0.18)", display: "grid", gap: 14, textAlign: "center", overflow: "hidden", animation: "vvGlow 4s ease-in-out infinite" },
  welcomeLogo: { height: 96, maxWidth: "100%", objectFit: "contain", margin: "0 auto 2px" },
  runningLineWrapper: { width: "100%", overflow: "hidden", background: "#fff", borderRadius: 999, padding: "8px 0 10px", borderTop: "1px solid rgba(176,0,32,0.10)", borderBottom: "1px solid rgba(176,0,32,0.10)" },
  runningLineTrack: { display: "flex", width: "max-content", whiteSpace: "nowrap", animation: "vvMarquee 30s linear infinite" },
  runningLineText: { color: "#e00000", fontFamily: "Brush Script MT, Segoe Script, Lucida Handwriting, Apple Chancery, cursive", fontSize: 36, fontWeight: 400, letterSpacing: 1.1, paddingRight: 58, textShadow: "0 1px 0 rgba(176,0,32,0.10)", lineHeight: 1.15 },
  welcomeTitle: { margin: "8px 0 0", fontSize: 34, lineHeight: 1.1, fontWeight: 900 },
  welcomeSubtitle: { margin: 0, color: "#555", fontSize: 15 },
  ahoyStartBox: { position: "relative", width: "min(100%, 660px)", aspectRatio: "3 / 1", minHeight: 0, margin: "0 auto", borderRadius: 24, overflow: "hidden", border: "1px solid rgba(224,0,0,0.16)", boxShadow: "0 12px 34px rgba(0,0,0,0.10)", background: "radial-gradient(circle at center, #ffffff 0%, #fffafa 45%, #fff0f0 100%)", display: "flex", alignItems: "center", justifyContent: "center" },
  ahoyStartButton: { padding: "8px 26px", border: 0, background: "transparent", color: "#e00000", fontFamily: "Brush Script MT, Segoe Script, Lucida Handwriting, Apple Chancery, cursive", fontSize: "clamp(62px, 10vw, 112px)", fontWeight: 400, cursor: "pointer", lineHeight: 0.9, letterSpacing: 1.2, textShadow: "0 3px 0 rgba(255,255,255,0.95), 0 0 20px rgba(255,255,255,0.95), 0 3px 10px rgba(176,0,32,0.18)" },
  ...
  welcomeFooterNote: { color: "#777", fontSize: 12, fontWeight: "bold", marginTop: 2 },
