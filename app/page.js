...
const styles = {
  ...
  ahoyStartButton: { padding: "18px 42px", border: 0, background: "transparent", color: "#e00000", fontFamily: "Brush Script MT, Segoe Script, Lucida Handwriting, Apple Chancery, cursive", fontSize: "clamp(40px, 6vw, 74px)", fontWeight: 400, cursor: "pointer", lineHeight: 0.9, letterSpacing: 1.2, textShadow: "0 4px 0 rgba(255,255,255,0.95), 0 0 24px rgba(255,255,255,0.95), 0 4px 12px rgba(176,0,32,0.18)" },
